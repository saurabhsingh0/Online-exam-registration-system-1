...
<?php
    ...
    $sql = "SELECT * FROM subject NATURAL JOIN exam WHERE subjectid = 'ICT01' AND examtype = 'written';";
    $result = mysqli_query($db, $sql) or die(mysqli_error($db));
    $sql = "SELECT * FROM subject NATURAL JOIN exam WHERE subjectid = 'ICT01' AND examtype = 'performance';";
