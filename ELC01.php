...
<html>
<head>
    <title>Exam description - Electric Railway</title>
</head>
<body>
<div class = "header">
    <h1>Exam description - Electric Railway</h1>
</div>
<style>
table, th, td {
...
<?php
    ...
    $sql = "SELECT * FROM subject NATURAL JOIN exam WHERE subjectid = 'ELC01' AND examtype = 'written';";
    $result = mysqli_query($db, $sql) or die(mysqli_error($db));
    $sql = "SELECT * FROM subject NATURAL JOIN exam WHERE subjectid = 'ELC01' AND examtype = 'performance';";
