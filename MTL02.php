...
<html>
<head>
    <title>Exam description - Rolling</title>
</head>
<body>
<div class = "header">
    <h1>Exam description - Rolling</h1>
</div>
<style>
table, th, td {
...
<?php
    ...
    $sql = "SELECT * FROM subject NATURAL JOIN exam WHERE subjectid = 'MTL02' AND examtype = 'written';";
    $result = mysqli_query($db, $sql) or die(mysqli_error($db));
    $sql = "SELECT * FROM subject NATURAL JOIN exam WHERE subjectid = 'MTL02' AND examtype = 'performance';";
